            ...
            <v-card-text class="card_background">
              <v-card-subtitle>
                <p class="card__subtitle">
                  aid:
                  <span class="card__describe">{{ currentUser.aid }}</span>
                </p>
                <p class="card__subtitle">
                  Gender:
                  <span class="card__describe">{{ currentUser.gender }}</span>
                </p>
                <p class="card__subtitle">
                  Role:
                  <span class="card__describe">{{ currentUser.role }}</span>
                </p>
                <p class="card__subtitle">
                  eMail:
                  <span class="card__describe">{{ currentUser.email }}</span>
                </p>
                <p class="card__subtitle">
                  Nickname:
                  <span class="card__describe">{{ currentUser.nickname }}</span>
                </p>
                <p class="card__subtitle">
                  Age: <span class="card__describe">{{ currentUser.age }}</span>
                </p>
                <p class="card__subtitle">
                  dbId:
                  <span class="card__describe">{{ currentUser.dbId }}</span>
                </p>
              </v-card-subtitle>
              <div class="wrapper_line_style">
                <EditUser :editUser="currentUser" />
                <DeletUser :deletUser="currentUser" />
              </div>
            </v-card-text>
          </v-card>
        </div>
...
export default {
  components: { EditUser, DeletUser, CreateUser },
  props: ['dbId'],
  computed: {
    currentUser() {
